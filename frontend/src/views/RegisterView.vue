  ...
  <div class="min-h-screen bg-midnight flex items-center justify-center px-4">
    <div class="w-full max-w-md">
      ...
      <div class="bg-card rounded-2xl p-8 shadow-2xl border border-white/5">
        <h1 class="text-xl font-semibold text-white mb-1">Create an account</h1>
        <p class="text-slate-400 text-sm mb-6">Get started with SwiftDrop for free</p>
        ...
        <p class="text-center text-slate-400 text-sm mt-6">
          ...
          <RouterLink to="/login" class="text-accent hover:text-accent-dark font-medium transition">Sign in</RouterLink>
        </p>
      </div>
    </div>
  </div>
